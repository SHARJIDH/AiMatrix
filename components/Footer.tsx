...
const AnimatedTitle = () => {
  return (
    <h1 className="text-purple-300 text-5xl font-bold lg:text-6xl mb-4 relative">
      <span className="absolute inset-0 animate-float">AiMatrix</span>
      <span className="relative z-10">AiMatrix</span>
    </h1>
  );
};
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="https://github.com/SHARJIDH/AiMatrix.git" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-purple-300 transition-colors">
          ...
          <div>
            ...
            <nav className="flex flex-col space-y-1 text-xs text-gray-400">
              ...
              <a className="hover:text-purple-300 transition-colors" href={"https://sharjidh-portfolio.vercel.app/"} target="_blank">Other projects</a>
              <a className="hover:text-purple-300 transition-colors" href={"https://github.com/SHARJIDH/AiMatrix.git"} target="_blank">Contribute</a>
            </nav>
          </div>
          <div>
